...
public class SeleniumTest extends BaseTest {
    ...
    // contoh kodingan yang kurang bagus adalah memasukan semua perintah pada main test, harus di pecah" based class berdasarkan step dan kegunaannya
    @Test
    public void testMidtrans() throws InterruptedException {
        ...
        Thread.sleep(2000); // sebisa mungkin jangan pake thread sleep
        homePage.fillFormCheckout("50000","Faris","imaduddin.muhammadfaris@gmail.com",
                "0895384323650","TangerangSelatan","Mawar V","1025");


//        // Shooping Chart Menu
//        w.until(ExpectedConditions.presenceOfElementLocated (By.xpath("//span[contains(.,'Shopping Cart')]")));
